              ...
              if (link.to === "/contact") {
                return (
                  <Button
                    ...
                    asChild
                    size="sm"
                    className="text-sm px-4 py-2 bg-accent hover:bg-accent-hover shadow-accent"
                  >
              ...
              if (link.to === "/contact") {
                return (
                  <Button
                    ...
                    asChild
                    size="sm"
                    className="text-sm px-4 py-2 bg-accent hover:bg-accent-hover shadow-accent w-full justify-start"
